...
void UIManager::openConsoleModal() {
    ...
    lv_obj_set_style_bg_color(mConsoleInputTa, lv_color_hex(0x222222), LV_STATE_ANY);
    lv_obj_set_style_bg_opa(mConsoleInputTa, LV_OPA_COVER, LV_STATE_ANY);
    lv_obj_set_style_text_color(mConsoleInputTa, lv_color_hex(0xFFFFFF), LV_STATE_ANY);
    lv_obj_set_style_border_color(mConsoleInputTa, lv_color_hex(0xFF0000), LV_STATE_ANY);
    lv_obj_set_style_border_width(mConsoleInputTa, 2, LV_STATE_ANY);
    lv_obj_set_style_text_font(mConsoleInputTa, &lv_font_montserrat_12, LV_STATE_ANY);
